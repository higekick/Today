...
extension ReminderViewController {
    ...
    func titleConfiguration(for cell: UICollectionViewListCell, with title: String?) -> TextFieldContentView.Configuration {
        ...
        contentConfiguration.text = title
        contentConfiguration.onChange = { [weak self] changeTitle in
            self?.workingReminder.title = changeTitle
        }
        return contentConfiguration
    }
    ...
    func dateConfiguration(for cell: UICollectionViewListCell, with date: Date) -> DatePickerContentView.Configuration {
        ...
        contentConfiguration.onChange = { [weak self] changeDate in
            self?.workingReminder.dueDate = changeDate
        }
        return contentConfiguration
    }
    ...
    func notesConfiguration(for cell: UICollectionViewListCell, with notes: String?) -> TextViewContentView.Configuration {
        ...
        contentConfiguration.onChange = { [weak self] changeNote in
            self?.workingReminder.notes = changeNote
        }
        return contentConfiguration
    }
